...
**Download the datafile (`SAFI_clean.csv`) from [this link](https://figshare.com/articles/dataset/SAFI_Survey_Results/6262019/4?file=11492171) and place it in the `data` folder of your directory**. In this dataset, the missing data is encoded as "NULL", each row holds
